...
void draw_arena_walls(void)
{
	for ( int i = 0; i < 16; ++i) {
		jo_3d_push_matrix();
		{
			...
			jo_3d_translate_matrixf(pos.x + ((wall_width * (((float)1/16)*i) * 1.95) ) - (player_start_pos_x * 3), pos.y - (player_start_pos_y * 3), pos.z + wall_half_height);
			jo_3d_draw(&wall1[i]);
		}
		jo_3d_pop_matrix();
		...
		{
			jo_3d_rotate_matrix_rad(rot.rx, rot.ry, rot.rz);
			jo_3d_translate_matrixf(pos.x - (player_start_pos_x * 3) + (wall_width * 1.85), pos.y - ((wall_width * (((float)1/16)*i) * 1.95) ) + (wall_width * 1.85) - (player_start_pos_y * 3), pos.z + wall_half_height);
			jo_3d_draw(&wall2[i]);
		}
		jo_3d_pop_matrix();
		...
		{
			jo_3d_rotate_matrix_rad(rot.rx, rot.ry, rot.rz);
			jo_3d_translate_matrixf(pos.x - ((wall_width * (((float)1/16)*i) * 1.95) ) + (wall_width * 1.85) - (player_start_pos_x * 3), pos.y + (wall_width * 1.85) - (player_start_pos_y * 3), pos.z + wall_half_height);
			jo_3d_draw(&wall3[i]);
		}
		jo_3d_pop_matrix();
		...
		{
			jo_3d_rotate_matrix_rad(rot.rx, rot.ry, rot.rz);
			jo_3d_translate_matrixf(pos.x - (player_start_pos_x * 3), pos.y + ((wall_width * (((float)1/16)*i) * 1.95) ) - (player_start_pos_y * 3), pos.z + wall_half_height);
			jo_3d_draw(&wall4[i]);
		}
		jo_3d_pop_matrix();
   	}
